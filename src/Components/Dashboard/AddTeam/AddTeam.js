    ...
    return (
        <section className="container-fluid row">
            ...
            <div className="col-md-10 p-4 pr-5" style={{ position: "absolute", right: 0, backgroundColor: "#f0f0ff" }}>
                <h5 className="text-styleA">Add a Team</h5>
                {alert && 
       ...
       <label htmlFor="exampleInputEmail1">Enter Designation</label>
        <input name="post" ref={register({ required: true })} type="text" placeholder="Post" className="form-control" required/>
        {errors.post && <span className="error">Post is required</span>}
        </div>
